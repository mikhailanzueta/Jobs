...
var bcryptjs_1 = require("bcryptjs"); // We will use bcryptjs to hash the password for security
var prisma = new client_1.PrismaClient();
prisma.user;
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var user, password, hashedPassword, userPassword;
                ...
                case 2:
                    ...
                    return [4 /*yield*/, prisma.userPassword.create({
                            data: {
                                ...
                                userId: user.id, // Associate the password with the user created earlier
                            },
                        })];
                case 3:
                    userPassword = _a.sent();
                    // Optionally, you can create an active password if needed (the ActiveUserPassword model)
                    return [4 /*yield*/, prisma.activeUserPassword.create({
                            data: {
                                userId: user.id,
